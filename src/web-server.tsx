...
import { GitHubFetcher } from "./web/github-fetcher.js"
...
app.listen(port, () => {
  ...
  if (!process.env.GITHUB_TOKEN) {
    console.log(`⚠️  Warning: GITHUB_TOKEN not set. Using unauthenticated GitHub API (60 req/hour).`)
  } else {
    console.log(`🔑 GitHub token detected. Authenticated rate limit enabled (up to 5000 req/hour).`)
  }
})
